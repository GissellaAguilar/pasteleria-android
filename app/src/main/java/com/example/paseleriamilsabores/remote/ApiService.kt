...
interface ApiService {
    ...
    // GET: /api/usuario/{run}
    @GET("/api/usuario/{run}")
    suspend fun getUsuarioByRun(@Path("run") run: String): Response<Usuario>

    // GET: /api/usuario
    @GET("/api/usuario")
    suspend fun listUsuarios(): Response<List<Usuario>>
    ...
    // DELETE: /api/usuario/{run} (Código 204 No Content)
